...
#define DIO_u8PORTA			0u  //for unsigned casting
#define DIO_u8PORTB			1u  //for unsigned casting
#define DIO_u8PORTC			2u  //for unsigned casting
#define DIO_u8PORTD			3u  //for unsigned casting
...
uint8 DIO_u8SetPortDirection(uint8 Copy_u8Port, uint8 Copy_u8Direction);//which port we want to srt, and which pin
